...
Данный контейнер используется для инъекции зависимостей между системами и компонентами. Может использоваться и для обычных классов. Был спроектирован как замена использованию имплементации паттерна "Service Locator".
